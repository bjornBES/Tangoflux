...
namespace TangoFlex.preprocessor
{
    ...
    public class TangoFlexPreprocessorEval
    {
        ...
        public TangoFlexPreprocessorEval(Token[] tokens, TangoFlexLexer tangoFlexLexer, TangoFlexPreprocessor tangoFlexPreprocessor, Arguments arguments)
        {
