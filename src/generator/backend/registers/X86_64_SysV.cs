...
public class X86_64_SysV : ICallingConvention
{
        ...
        new Dictionary<RegisterFunction, RegisterInfo>()
    {
        ...
        // Addressing in data/rodata
        { RegisterFunction.AddressBase,         new RegisterInfo("r10", 11) },
        { RegisterFunction.AddressIndex,        new RegisterInfo("rsi", 5) },

        // Multiply / Divide
        { RegisterFunction.MultiplySource1,     new RegisterInfo("rax", 3) },
        { RegisterFunction.MultiplyResultLow,   new RegisterInfo("rax", 3) },
        { RegisterFunction.MultiplyResultHigh,  new RegisterInfo("rdx", 6) },

        { RegisterFunction.DivideDividendLow,   new RegisterInfo("rax", 3) },
        { RegisterFunction.DivideDividendHigh,  new RegisterInfo("rdx", 6) },
        { RegisterFunction.DivideQuotient,      new RegisterInfo("rax", 3) },
        { RegisterFunction.DivideRemainder,     new RegisterInfo("rdx", 6) },
    };
